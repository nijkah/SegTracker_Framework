...
def aug_pair(img_template, img_search, gt_template, gt_search):
    ...
    img_search= crop_and_padding(img_search, gt_search, (dim, dim)).astype('uint8')
    gt_search= crop_and_padding(gt_search, gt_search, (dim, dim)).astype('uint8')
    ...
    for i in range(10):
        ...
        gt_search = ia.SegmentationMapOnImage(gt_search, shape=gt_search.shape, nb_classes=2)
